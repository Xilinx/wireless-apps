...
/* Type = rw  */
#define RADIO_SOURCE_ENABLE_ADDR 0x2c /* 44 */
#define RADIO_SOURCE_ENABLE_MASK 0x1 /* 1 */
#define RADIO_SOURCE_ENABLE_OFFSET 0x0 /* 0 */
#define RADIO_SOURCE_ENABLE_WIDTH 0x1 /* 1 */
#define RADIO_SOURCE_ENABLE_DEFAULT 0x1 /* 1 */

/* Type = rw  */
#define RADIO_SINK_ENABLE_ADDR 0x2c /* 44 */
#define RADIO_SINK_ENABLE_MASK 0x2 /* 2 */
#define RADIO_SINK_ENABLE_OFFSET 0x1 /* 1 */
...
/* Type = rwInt  */
#define RADIO_APP_SCRATCH_REG_0_ADDR 0x50 /* 80 */
#define RADIO_APP_SCRATCH_REG_0_MASK 0xffff /* 65535 */
#define RADIO_APP_SCRATCH_REG_0_OFFSET 0x0 /* 0 */
#define RADIO_APP_SCRATCH_REG_0_WIDTH 0x10 /* 16 */
#define RADIO_APP_SCRATCH_REG_0_DEFAULT 0x0 /* 0 */

/* Type = rwInt  */
#define RADIO_APP_SCRATCH_REG_1_ADDR 0x54 /* 84 */
#define RADIO_APP_SCRATCH_REG_1_MASK 0xffff /* 65535 */
#define RADIO_APP_SCRATCH_REG_1_OFFSET 0x0 /* 0 */
#define RADIO_APP_SCRATCH_REG_1_WIDTH 0x10 /* 16 */
#define RADIO_APP_SCRATCH_REG_1_DEFAULT 0x0 /* 0 */

/* Type = rwInt  */
#define RADIO_APP_SCRATCH_REG_2_ADDR 0x58 /* 88 */
#define RADIO_APP_SCRATCH_REG_2_MASK 0xffff /* 65535 */
#define RADIO_APP_SCRATCH_REG_2_OFFSET 0x0 /* 0 */
#define RADIO_APP_SCRATCH_REG_2_WIDTH 0x10 /* 16 */
#define RADIO_APP_SCRATCH_REG_2_DEFAULT 0x0 /* 0 */

/* Type = rwInt  */
#define RADIO_APP_SCRATCH_REG_3_ADDR 0x5c /* 92 */
#define RADIO_APP_SCRATCH_REG_3_MASK 0xffff /* 65535 */
#define RADIO_APP_SCRATCH_REG_3_OFFSET 0x0 /* 0 */
#define RADIO_APP_SCRATCH_REG_3_WIDTH 0x10 /* 16 */
#define RADIO_APP_SCRATCH_REG_3_DEFAULT 0x0 /* 0 */
